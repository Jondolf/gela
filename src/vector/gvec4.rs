...
impl<T: Copy + NumOrd> GVec4<T> {
    ...
    pub fn min_element_fast(self) -> T {
        self.x.min_fast(self.y).min_fast(self.z).min_fast(self.w)
    }
    ...
    pub fn max_element_fast(self) -> T {
        self.x.max_fast(self.y).max_fast(self.z).max_fast(self.w)
    }
}
...
impl<T: Real> GVec4<T> {
    ...
    pub fn round_ties_even(self) -> Self {
        Self::new(
            Real::round_ties_even(self.x),
            Real::round_ties_even(self.y),
            Real::round_ties_even(self.z),
            Real::round_ties_even(self.w),
        )
    }
    ...
    pub fn midpoint_fast(self, rhs: Self) -> Self {
        Self::new(
            ...
            Real::midpoint_fast(self.w, rhs.w),
        )
    }
...
impl<T: Copy> GVec4<T> {
    ...
    where
        T: NumCast<U>,
    {
        GVec4::new(self.x.cast(), self.y.cast(), self.z.cast(), self.w.cast())
    }
}
...
impl GVec4<f32> {
    ...
    #[inline(always)]
    #[must_use]
    pub const fn to_vec4a(self) -> Vec4A {
        Vec4A::from_vec4(self)
    }
}
...
impl GVec4<f64> {
    ...
    #[inline]
    #[must_use]
    pub fn to_vec4a(self) -> Vec4A {
        Vec4A::from_vec4(self.cast())
    }
}
