...
impl<T: Copy + NumOrd> GVec2<T> {
    ...
    pub fn min_fast(self, rhs: Self) -> Self {
        Self::new(self.x.min_fast(rhs.x), self.y.min_fast(rhs.y))
    }
    ...
    pub fn max_fast(self, rhs: Self) -> Self {
        Self::new(self.x.max_fast(rhs.x), self.y.max_fast(rhs.y))
    }
...
impl<T: Real> GVec2<T> {
    ...
    pub fn round_ties_even(self) -> Self {
        Self::new(self.x.round_ties_even(), self.y.round_ties_even())
    }
    ...
    pub fn exp_stable(self) -> Self {
        Self::new(self.x.exp_stable(), self.y.exp_stable())
    }
    ...
    pub fn exp2_stable(self) -> Self {
        Self::new(self.x.exp2_stable(), self.y.exp2_stable())
    }
    ...
    pub fn ln_stable(self) -> Self {
        Self::new(self.x.ln_stable(), self.y.ln_stable())
    }
    ...
    pub fn log2_stable(self) -> Self {
        Self::new(self.x.log2_stable(), self.y.log2_stable())
    }
    ...
    /// against overflow and underflow. For example, `GVec2::MAX.midpoint(GVec2::MAX)` is `GVec2::MAX`,
    /// but `GVec2::MAX.midpoint_fast(GVec2::MAX)` overflows to `GVec2::INFINITY`.
    #[inline]
    #[must_use]
    pub fn midpoint_fast(self, rhs: Self) -> Self {
        Self::new(self.x.midpoint_fast(rhs.x), self.y.midpoint_fast(rhs.y))
    }
    ...
    /// `self.angle_to(rhs)`, the result will be parallel to `rhs`. If `max_angle` is negative,
